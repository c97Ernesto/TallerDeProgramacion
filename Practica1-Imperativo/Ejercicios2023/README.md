...
Implementar un programa que invoque los siguientes módulos:
	...
	1. Un módulo que retorne la información de las ventas en un vector. De cada venta se conoce el día de la venta, código del producto (entre 1 y 15) y cantidad vendida  como máximo 99 unidades). El código debe generarse automáticamente (random) y la cantidad se debe leer. El ingreso de las ventas finaliza con el día de venta 0 (no se procesa).
	
	2. Un módulo que muestre el contenido del vector resultante del punto a).

	3. Un módulo que ordene el vector de ventas por código. 
	
	4. Un módulo que muestre el contenido del vector resultante del punto c).
	
	5. Un módulo que elimine, del vector ordenado, las ventas con código de producto entre dos valores que se ingresan como parámetros.
	
	6. Un módulo que muestre el contenido del vector resultante del punto e).
	
	7. Un módulo que retorne la información (ordenada por código de producto de menor a mayor) de cada código par de producto junto a la cantidad total de productos vendidos.
	
	8. Un módulo que muestre la información obtenida en el punto 7).

	- [Resolución Ejercicio 1](./ejercicios-resueltos/parte1_ejercicio1.pas)
...
Implementar un programa que invoque a módulos para cada uno de los siguientes puntos:
	...
	- [Resolución Ejercicio 2](./ejercicios-resueltos/parte1_ejercicio2.pas)
...
Implementar un programa que invoque a módulos para cada uno de los siguientes puntos:
	...
	- [Resolución Ejercicio 3](./ejercicios-resueltos/parte1_ejercicio3.pas)
...
Implementar un programa que invoque a módulos para cada uno de los siguientes puntos:
	...
	- [Resolución Ejercicio 4](./ejercicios-resueltos/parte1_ejercicio4.pas)
...
1. Implementar un programa que invoque a los siguientes módulos.
	...
	- [Resolución Ejercicio 1](./ejercicios-resueltos/parte2_ejercicio1.pas)
...
6. Realizar un programa que lea números hasta leer el valor 0 e imprima, para cada número leído, sus dígitos en el orden en que aparecen en el número. Debe implementarse un módulo recursivo que reciba el número e imprima lo pedido. Ejemplo si se lee el valor 256, se debe imprimir 2 5 6.
	...
	- [Resolución Ejercicio 2](./ejercicios-resueltos/parte2_ejercicio2.pas)
...
7. Escribir un programa que:
	...
	- [Resolución Ejercicio 3](./ejercicios-resueltos/parte2_ejercicio3.pas)
...
8. Escribir un programa con:
	...
	- [Resolución Ejercicio 4](./ejercicios-resueltos/parte2_ejercicio4.pas)
...
en el vector.
	...
	- [Resolución Ejercicio 5](./ejercicios-resueltos/parte2_ejercicio5.pas)
...
el número 0 (cero).
	...
	- [Resolución Ejercicio 6](./ejercicios-resueltos/parte2_ejercicio6.pas)

## Parte 3: Árboles 1

1. **Escribir un programa que:**
	1. Implemente un módulo que lea información de socios de un club y las almacene en un árbol binario de búsqueda. De cada socio se lee número de socio, nombre y edad. La lectura finaliza con el número de socio 0 y el árbol debe quedar ordenado por número de socio.

	2. Una vez generado el árbol, realice módulos independientes que reciban el árbol como parámetro y que :

		1. Informe el número de socio más grande. Debe invocar a un módulo recursivo que retorne dicho valor.

		2. Informe los datos del socio con el número de socio más chico. Debe invocar a un módulo recursivo que retorne dicho socio.

		3. Informe el número de socio con mayor edad. Debe invocar a un módulo recursivo que retorne dicho valor.

		4. Aumente en 1 la edad de todos los socios.

		5. Lea un valor entero e informe si existe o no existe un socio con ese valor. Debe invocar a un módulo recursivo que reciba el valor leído y retorne verdadero o falso.

		6. Lea un nombre e informe si existe o no existe un socio con ese nombre. Debe invocar a un módulo recursivo que reciba el nombre leído y retorne verdadero o falso.

		7. Informe la cantidad de socios. Debe invocar a un módulo recursivo que retorne dicha cantidad.

		8. Informe el promedio de edad de los socios. Debe invocar al módulo recursivo del inciso vii e invocar a un módulo recursivo que retorne la suma de las edades de los socios.

		9. Informe, a partir de dos valores que se leen, la cantidad de socios en el árbol cuyo número de socio se encuentra entre los dos valores ingresados. Debe invocar a un módulo recursivo que reciba los dos valores leídos y retorne dicha cantidad.

		10. Informe los números de socio en orden creciente.

		11. Informe los números de socio pares en orden decreciente.

	- [Resolución Ejercicio 1](./ejercicios-resueltos/parte3_ejercicio1.pas)


12. **Escribir un programa que:**

	1. Implemente un módulo que lea información de ventas de un comercio. De cada venta se lee código de producto, fecha y cantidad de unidades vendidas. La lectura finaliza con el código de producto 0. Un producto puede estar en más de una venta. Se pide:
	
		1. Generar y retornar un árbol binario de búsqueda de ventas ordenado por código de producto.

		2. Generar y retornar otro árbol binario de búsqueda de productos vendidos ordenado por código de producto. Cada nodo del árbol debe contener el código de producto y la cantidad total de unidades vendida.

		Nota: El módulo debe retornar los dos árboles.

	2. Implemente un módulo que reciba el árbol generado en a. y un código de producto y retorne la cantidad total de unidades vendidas de ese producto.

	3. Implemente un módulo que reciba el árbol generado en b. y un código de producto y retorne la cantidad total de unidades vendidas de ese producto.

	- [Resolución Ejercicio 2](./ejercicios-resueltos/parte3_ejercicio2.pas)
...
13. Implementar un programa que contenga:
	...
	- [Resolución Ejercicio 3](./ejercicios-resueltos/parte3_ejercicio3.pas)
...
1. Implementar un programa modularizado para una librería que:
	...
	- [Resolución Ejercicio 1](./ejercicios-resueltos/parte4_ejercicio1.pas)
...
y mes del préstamo y cantidad de días prestados. Implementar un programa con:
	...
	- [Resolución Ejercicio 2](./ejercicios-resueltos/parte4_ejercicio2.pas)
...
Esta carrera tiene 30 materias. Implementar un programa con:
	...
	- [Resolución Ejercicio 3](./ejercicios-resueltos/parte4_ejercicio3.pas)
...
1. El administrador de un edificio de oficinas, cuenta en papel, con la información del pago de las expensas de dichas oficinas. Implementar un programa con:
	...
	- [Resolución Ejercicio 1](./ejercicios-resueltos/parte5_ejercicio1.pas)
...
18. Una agencia dedicada a la venta de autos ha organizado su stock y, dispone en papel de la información de los autos en venta. Implementar un programa que:
	...
	- [Resolución Ejercicio 2](./ejercicios-resueltos/parte5_ejercicio2.pas)
...
19. Un supermercado requiere el procesamiento de sus productos. De cada producto se conoce código, rubro (1..10), stock y precio unitario. Se pide:
	...
	- [Resolución Ejercicio 3](./ejercicios-resueltos/parte5_ejercicio3.pas)
...
20. Una oficina requiere el procesamiento de los reclamos de las personas. De cada reclamo se lee código, DNI de la persona, año y tipo de reclamo. La lectura finaliza con el código de igual a -1. Se pide:
	...
	- [Resolución Ejercicio 4](./ejercicios-resueltos/parte1_ejercicio5.pas)
...
21. Realizar el punto a) del ejercicio anterior, pero sabiendo que todos los reclamos de un mismo DNI se leen de forma consecutiva (no significa que vengan ordenados los DNI).
	...
	- [Resolución Ejercicio 5](./ejercicios-resueltos/parte5_ejercicio5.pas)